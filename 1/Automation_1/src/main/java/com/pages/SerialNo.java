...
public class SerialNo extends TestBase{
	...
	@FindBy(xpath = "//*[@class=\"available-items\"]/li[contains(text(),'Serial No')]")
	...
	public void DT4() throws InterruptedException	
	{
		String x="Alerts";
		try
		{ 
